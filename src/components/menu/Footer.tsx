  ...
  return (
    <div className="pt-8 flex flex-col justify-center items-center">
      <div className="bg-[#15335D] text-white justify-center flex py-16 max-md:py-8 w-full">
        <div className="flex items-start justify-between md:max-lg:justify-around w-[80%] max-xl:w-[90%] max-lg:w-[98%] max-md:w-[95%] max-md:flex-col max-md:items-center max-md:gap-10">
          <div className="flex flex-col gap-8  items-center">
            ...
            <div className="gap-5 flex flex-col max-md:items-center ">
              ...
              <p className="flex gap-2 items-center">
                <CiMail size={25} /> {companyData.email}
              </p>
            </div>
          </div>
          <div className=" flex w-1/3 max-md:w-full justify-between max-md:justify-center items-center max-md:gap-20 md:max-lg:hidden ">
            <div className="flex-col flex gap-4">
              <div className="flex justify-start flex-col gap-4">
                ...
                <Link href="/about">
                  <p className="   hover:text-white cursor-pointer">À propos</p>
                </Link>
                <Link href="/contactus">
          ...
          <div className="flex flex-col gap-4  items-center">
            <p className="max-md:text-2xl max-sm:text-xl">
              Abonnez-vous a notre newsletter!
            </p>
            <div className="relative w-full">
              <input
                id="email" // Unique identifier for this input
                name="email" // Name attribute helps with form submission and autofill
              ...
              <div className=" absolute right-2 top-1/2 group overflow-hidden  -translate-y-1/2">
                <button
                  className="relative  py-2 w-[40px] h-[40px] max-md:w-[50px] max-md:h-[50px] hover:bg-[#15335D]     px-2   rounded-full text-white bg-primary  "
                  aria-label="send"
                ></button>
            ...
            <div className="flex  items-center gap-2">
              ...
              <FaInstagram
                className="hover:bg-gradient-to-r from-orange-500 overflow-hidden rounded-lg via-pink-500 to-indigo-500 "
                fill="currentcolor"
                size={25}
              />
            </div>
      ...
      <div className="w-[85%] text-[20px] items-center justify-between text-[#525566] font-bold max-lg:w-[95%] max-md:text-[16px] py-2 flex max-md:flex-col gap-2">
        ...
        <div className=" flex items-center gap-8 mx-4 max-md:text-[12px] text-[16px]">
